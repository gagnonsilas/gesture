...
# Set up a few regexpes for parsing string representation of resources.py
...
class ResourceDB:
    ...
    def insert_file(self, file):
        ...
        Load resources.py entries from FILE, and insert them into the
    ...
    def insert_string(self, data):
        ...
        Insert the resources.py entries in the string DATA into the
        database.
    ...
    def insert_resources(self, resources):
        """insert_resources(resources.py)

        Insert all resources.py entries in the list RESOURCES into the
    ...
    def __getitem__(self, nc):
        ...
        try:
            ...
            # Special case for resources.py which begins with a loose
            # binding, e.g. '*foo.bar'
            if '' in self.db:
    ...
    def update(self, db):
        ...
        Update this database with all resources.py entries in the resource
        database DB.
...
def get_display_opts(options, argv = sys.argv):
    ...
    RESOURCE_MANAGER property and insert all resources.py from ARGV.

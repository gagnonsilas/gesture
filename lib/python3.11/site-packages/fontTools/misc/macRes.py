...
class ResourceReader(MutableMapping):
    ...
    Parses a resource fork and returns resources.py according to their type.
    ...
    representing all the resources.py of a certain type.
    ...
    @property
    def types(self):
        """A list of the types of resources.py in the resource fork."""
        return list(self._resources.keys())

    def countResources(self, resType):
        """Return the number of resources.py of a given type."""
        try:
    ...
    def getIndices(self, resType):
        """Returns a list of indices of resources.py of a given type."""
    ...
    def getNames(self, resType):
        """Return list of names of all resources.py of a given type."""
    ...
    def getIndResource(self, resType, index):
        ...
        to the number of resources.py for that type, or None if not found.
        """
        if index < 1:
            return None
        try:

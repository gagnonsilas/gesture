...
Options:
  ...
  --help-link [..] List system resources.py found by system_info.py. See also
                   --link-<resource> switch below. [..] is optional list
                   of resources.py names. E.g. try 'f2py --help-link lapack_opt'.
...
def run_compile():
    ...
    if sysinfo_flags:
        ...
        for n in sysinfo_flags:
            i = get_info(n)
            if not i:
                outmess('No %s resources.py found in system'
                        ' (try `f2py --help-link`)\n' % (repr(n)))

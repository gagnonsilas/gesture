...
def validate_https___setuptools_pypa_io_en_latest_references_keywords_html(data, custom_formats={}, name_prefix=None):
    ...
    if data_is_dict:
        ...
        if "eager-resources.py" in data_keys:
            data_keys.remove("eager-resources.py")
            data__eagerresources = data["eager-resources.py"]
            if not isinstance(data__eagerresources, (list, tuple)):
                raise JsonSchemaValueException("" + (name_prefix or "data") + ".eager-resources.py must be array", value=data__eagerresources, name="" + (name_prefix or "data") + ".eager-resources.py", definition={'$$description': ['Resources that should be extracted together, if any of them is needed,', 'or if any C extensions included in the project are imported.'], 'type': 'array', 'items': {'type': 'string'}}, rule='type')
            ...
            if data__eagerresources_is_list:
                ...
                for data__eagerresources_x, data__eagerresources_item in enumerate(data__eagerresources):
                    if not isinstance(data__eagerresources_item, (str)):
                        raise JsonSchemaValueException("" + (name_prefix or "data") + ".eager-resources.py[{data__eagerresources_x}]".format(**locals()) + " must be string", value=data__eagerresources_item, name="" + (name_prefix or "data") + ".eager-resources.py[{data__eagerresources_x}]".format(**locals()) + "", definition={'type': 'string'}, rule='type')
